...
let currentNumber = 0;
fetch('http://85.209.2.107:4100/statist')
...
fetch('http://85.209.2.107:4100/team')
    .then(response => response.json())
    .then(data => {
        ...
        data.forEach(teamItem => {
            if (teamItem.type === 'mahalliy') {
                ...
                teamImage.src = `http://85.209.2.107:4100/uploads/${teamItem.img}`;
                teamImage.alt = '';
...
fetch('http://85.209.2.107:4100/abaut')
    .then(response => response.json())
    .then(data => {
        ...
        data.forEach(abautItem => {
            ...
            mainImage.src = `http://85.209.2.107:4100/uploads/${abautItem.img}`;
            mainImage.alt = '';
...
fetch('http://85.209.2.107:4100/slider')
    .then(response => response.json())
    .then(data => {
        ...
        data.forEach(sliderItem => {
            ...
            swiperSlide.style.backgroundImage = `url(http://85.209.2.107:4100/uploads/${sliderItem.img})`;
...
fetch('http://85.209.2.107:4100/gallery')
    .then(response => response.json())
    .then(data => {
        ...
        data.forEach(photoItem => {
            ...
            image.src = `http://85.209.2.107:4100/uploads/${photoItem.img}`;
            image.alt = '';
    ...
    document.getElementById('contactForm').addEventListener('submit', function (e) {
        ...
        fetch('http://85.209.2.107:4100/contact/create', {
            method: 'POST',
            headers: {
